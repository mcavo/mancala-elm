    ...
    div [ class "row", style [ ("padding", "100px 15px 0") ] ]
        [ div [ class "col-md-offset-3 col-md-6"]
              ...
              , div [ section ]
                    ...
                    , p [ sectionText ] [ text "The object of the game is to capture more seeds than your opponent. Captured seeds are kept in the larger pits on the ends, which are known as stores. Your store is in your right, your opponent's is on your left. When the game begins they are empty." ]]
              , div [ section ]
              ...
              , div [ section ]
                    ...
                    , p [ sectionText ] [ text "Players alternate turns until one player exhausts all the seeds from all the houses on this side of the board. On his turn a player selects a house on his side of the board, takes all the seeds, and sows the seeds one-by-one into the subsequent houses in a counter-clockwise direction around the board. If he reaches his store, then the player will place one seed in his store, gaining a point. If a player reaches the other player's store while seeding, then it is skipped." ]]
              , div [ section ]
